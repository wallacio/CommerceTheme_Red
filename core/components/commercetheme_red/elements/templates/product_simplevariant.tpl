    ...
    <div class="row equal product-top-container">
        <div class="col-md product-image">
            <div class="product-image__container">
                ...
                <img src="[[+product.image:default=`https://placekitten.com/600/400`]]" data-original-image="[[+product.image:default=`https://placekitten.com/600/400`]]" class="product-image__img" alt="[[*longtitle:default=`[[*pagetitle]]`:htmlent]]">
            </div>
        </div>
        <div class="col-md product-details">
            ...
            <form method="post" action="[[~[[++commerce.cart_resource]]]]" class="product-add-to-cart add-to-cart add-to-cart__simplevariant">
                <input type="hidden" name="add_to_cart" value="1">
                <input type="hidden" name="link" value="[[*id]]">

                [[!commerce.get_products?
                    &products=`[[*products]]`
                    &tpl=`tplProductSimpleVariantOption`
                    &wrapperTpl=`tplProductSimpleVariantSelectWrapper` 
                ]]
